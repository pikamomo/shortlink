...
package com.chi.shortlink.admin.common.web;

import cn.hutool.core.collection.CollectionUtil;
import cn.hutool.core.util.ReflectUtil;
import cn.hutool.core.util.StrUtil;
import com.chi.shortlink.admin.common.convention.errorcode.BaseErrorCode;
import com.chi.shortlink.admin.common.convention.exception.AbstractException;
...
public class GlobalExceptionHandler {
    ...
    /**
     * Intercept parameter validation exceptions
     */
    @SneakyThrows
    ...
    public Result defaultErrorHandler(HttpServletRequest request, Throwable throwable) {
        ...
        // Note: This code is added for aggregation mode, normally this check is not needed
