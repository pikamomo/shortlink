...
import com.chi.shortlink.admin.dao.entity.GroupUniqueDO;
import com.chi.shortlink.admin.dao.mapper.GroupMapper;
import com.chi.shortlink.admin.dao.mapper.GroupUniqueMapper;
...
import static com.chi.shortlink.admin.common.constant.RedisCacheConstant.LOCK_GROUP_CREATE_KEY;
    ...
    public void saveGroup(String username, String groupName) {
        ...
        try {
            ...
            if (StrUtil.isEmpty(gid)) {
                throw new ServiceException("Generate group identifier frequently");
            }
        } finally {
            lock.unlock();
        }
