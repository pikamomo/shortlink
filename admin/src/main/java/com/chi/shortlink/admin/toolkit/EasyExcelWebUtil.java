...
/**
 * Encapsulates EasyExcel operations for web utility methods
 *
 */
public class EasyExcelWebUtil {

    /**
     * Writes an Excel response to the browser, directly returning the user download data
     *
     * @param response Response
     * @param fileName File name
     * @param clazz    Specified write class
