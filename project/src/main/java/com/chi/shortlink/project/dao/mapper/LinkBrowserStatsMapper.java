...
/**
 * Browser statistics access persistence layer
 *
 */
public interface LinkBrowserStatsMapper extends BaseMapper<LinkBrowserStatsDO> {

    /**
     * Record browser access monitoring data
     */
    @Insert("INSERT INTO " +
    ...
    /**
     * Get browser monitoring data within a specified date based on the short link
     */
    @Select("SELECT " +
            "    tlbs.browser, " +
    ...
    /**
     * Get browser monitoring data within a specified date based on the group
     */
    @Select("SELECT " +
            "    tlbs.browser, " +
            "    SUM(tlbs.cnt) AS count " +
