...
import com.chi.shortlink.project.common.enums.VailDateTypeEnum;
import com.chi.shortlink.project.config.GotoDomainWhiteListConfiguration;
...
import com.chi.shortlink.project.dto.resp.ShortLinkBaseInfoRespDTO;
...
import com.chi.shortlink.project.mq.producer.ShortLinkStatsSaveProducer;
...
public class ShortLinkServiceImpl extends ServiceImpl<ShortLinkMapper, ShortLinkDO> implements ShortLinkService {
    ...
    public ShortLinkBatchCreateRespDTO batchCreateShortLink(ShortLinkBatchCreateReqDTO requestParam) {
        ...
        for (int i = 0; i < originUrls.size(); i++) {
            ...
            try {
                ...
                log.error("Batch creation of short links failed, original parameter: {}", originUrls.get(i));
            }
        }
    ...
    public void updateShortLink(ShortLinkUpdateReqDTO requestParam) {
        ...
        if (Objects.equals(hasShortLinkDO.getGid(), requestParam.getGid())) {
            ...
            // when gid changes, need to lock the old record and update the new record
    ...
    private void verificationWhitelist(String originUrl) {
        ...
        if (StrUtil.isBlank(domain)) {
            throw new ClientException("Redirect link is incorrect");
        }
        List<String> details = gotoDomainWhiteListConfiguration.getDetails();
        if (!details.contains(domain)) {
            throw new ClientException("In the demo environment, to avoid malicious attacks, please generate links for the following sites: "
