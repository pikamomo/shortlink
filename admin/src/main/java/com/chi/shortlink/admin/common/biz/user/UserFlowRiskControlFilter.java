...
import com.chi.shortlink.admin.config.UserFlowRiskControlConfiguration;
...
import static com.chi.shortlink.admin.common.convention.errorcode.BaseErrorCode.FLOW_LIMIT_ERROR;

/**
 * User Operation Flow Risk Control Filter
 */
@Slf4j
...
public class UserFlowRiskControlFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain filterChain) throws IOException, ServletException {
        ...
        try {
            ...
            log.error("Error executing user request flow limit LUA script", ex);
