...
/**
 * link access stats Persistence Layer
 */
@Mapper
public interface LinkAccessStatsMapper extends BaseMapper<LinkAccessStatsDO> {
    ...
    /**
     * get daily stats according to specified date
     */
    @Select("SELECT " +
            "    date, " +
            "    SUM(pv) AS pv, " +
    ...
    /**
     * get hourly stats according to specified date
     */
    @Select("SELECT " +
            "    hour, " +
            "    SUM(pv) AS pv " +
    ...
    /**
     * get weekly stats according to specified date
     * @param requestParam
     * @return
     */
    @Select("SELECT " +
