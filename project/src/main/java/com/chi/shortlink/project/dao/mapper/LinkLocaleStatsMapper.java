...
/**
 * Regional statistics access persistence layer
 *
 */
public interface LinkLocaleStatsMapper extends BaseMapper<LinkLocaleStatsDO> {

    /**
     * Record regional access monitoring data
     */
    @Insert("INSERT INTO " +
    ...
    /**
     * Get regional monitoring data within a specified date based on the short link
     */
    @Select("SELECT " +
            "    tlls.province, " +
            "    SUM(tlls.cnt) AS cnt " +
    ...
    /**
     * Get regional monitoring data within a specified date based on the group
     */
    @Select("SELECT " +
            "    tlls.province, " +
            "    SUM(tlls.cnt) AS cnt " +
