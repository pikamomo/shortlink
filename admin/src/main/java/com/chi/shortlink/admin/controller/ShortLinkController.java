...
import com.chi.shortlink.admin.remote.ShortLinkActualRemoteService;
...
import com.chi.shortlink.admin.remote.dto.resp.ShortLinkBaseInfoRespDTO;
...
import com.chi.shortlink.admin.toolkit.EasyExcelWebUtil;
...
public class ShortLinkController {
    ...
    public void batchCreateShortLink(@RequestBody ShortLinkBatchCreateReqDTO requestParam, HttpServletResponse response) {
        ...
        if (shortLinkBatchCreateRespDTOResult.isSuccess()) {
            ...
            EasyExcelWebUtil.write(response, "Batch Create Short Links - SaaS Short Link System", ShortLinkBaseInfoRespDTO.class, baseLinkInfos);
        }
    }
