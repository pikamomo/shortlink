...
import static com.chi.shortlink.admin.common.constant.RedisCacheConstant.USER_LOGIN_KEY;
import static com.chi.shortlink.admin.common.enums.UserErrorCodeEnum.USER_EXIST;
import static com.chi.shortlink.admin.common.enums.UserErrorCodeEnum.USER_NAME_EXIST;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, UserDO> implements UserService {
    ...
    public void update(UserUpdateReqDTO requestParam) {
        if (!Objects.equals(requestParam.getUsername(), UserContext.getUsername())) {
            throw new ClientException("update user info error");
        }
