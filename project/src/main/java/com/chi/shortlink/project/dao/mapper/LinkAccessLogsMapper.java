...
/**
 * Access log monitoring persistence layer
 *
 */
public interface LinkAccessLogsMapper extends BaseMapper<LinkAccessLogsDO> {

    /**
     * Get high-frequency access IP data within a specified date based on the short link
     */
    @Select("SELECT " +
            "    tlal.ip, " +
    ...
    /**
     * Get high-frequency access IP data within a specified date based on the group
     */
    @Select("SELECT " +
            "    tlal.ip, " +
            "    COUNT(tlal.ip) AS count " +
    ...
    /**
     * Get new and old visitor data within a specified date based on the short link
     */
    @Select("SELECT " +
    ...
    /**
     * Get user information to determine if they are new or old visitors
     */
    @Select("<script> " +
            "SELECT " +
            "    tlal.user, " +
    ...
    /**
     * Get group user information to determine if they are new or old visitors
     */
    @Select("<script> " +
            "SELECT " +
            "    tlal.user, " +
    ...
    /**
     * Get PV, UV, UIP data within a specified date based on the short link
     */
    @Select("SELECT " +
    ...
    /**
     * Get PV, UV, UIP data within a specified date based on the group
     */
    @Select("SELECT " +
            "    COUNT(tlal.user) AS pv, " +
            "    COUNT(DISTINCT tlal.user) AS uv, " +
    ...
    /**
     * Get access log data within a specified date based on the short link
     */
    @Select("SELECT " +
            "    tlal.* " +
            "FROM " +
    ...
    IPage<LinkAccessLogsDO> selectShortLinkPage(@Param("param") ShortLinkStatsReqDTO requestParam);

    /**
     * Get access log data within a specified date based on the group
     */
    @Select("SELECT " +
            "    tlal.* " +
            "FROM " +
