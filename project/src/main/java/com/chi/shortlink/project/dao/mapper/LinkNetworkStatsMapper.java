...
/**
 * Network access monitoring persistence layer
 *
 */
public interface LinkNetworkStatsMapper extends BaseMapper<LinkNetworkStatsDO> {

    /**
     * Record network access monitoring data
     */
    @Insert("INSERT INTO " +
    ...
    /**
     * Get network monitoring data within a specified date based on the short link
     */
    @Select("SELECT " +
            "    tlns.network, " +
            "    SUM(tlns.cnt) AS cnt " +
    ...
    /**
     * Get network monitoring data within a specified date based on the group
     */
    @Select("SELECT " +
            "    tlns.network, " +
            "    SUM(tlns.cnt) AS cnt " +
