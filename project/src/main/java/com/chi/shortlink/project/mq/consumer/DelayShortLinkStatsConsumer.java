...
import static com.chi.shortlink.project.common.constant.RedisKeyConstant.DELAY_QUEUE_STATS_KEY;

/**
 * Delayed recording of short link statistics component
 *
 */
@Deprecated
@Slf4j
                        ...
                        try {
                            ...
                            if (statsRecord != null) {
                                ...
                                try {
                                    ...
                                    log.error("Exception in delayed recording of short link monitoring consumption", ex);
                                }
